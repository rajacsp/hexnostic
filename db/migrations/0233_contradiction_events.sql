...
-- Existing callers keep the four-column contract, but cases—not a lossy AGE
-- scan—are now the durable source of truth.
...
$prompt$,
    'Model adjudication for database-selected contradiction candidates.',
