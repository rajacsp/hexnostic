-- Wave B everyday-life API connector manifests.
-- Provider secrets remain outside Postgres; metadata stores references only.
SET search_path = public, ag_catalog, "$user";

INSERT INTO integration_connectors (
    id, display_name, category, auth_type, status,
    capability_manifest, setup_manifest, docs_url, metadata
) VALUES
(
    'notion', 'Notion', 'productivity', 'api_key', 'available',
    '{
    ...
    '{
      "flow": "explicit_env_reference", "secret_storage": "environment",
      "supported_surfaces": ["chat", "cli", "web", "mcp"],
      "default_capabilities": ["search", "read", "query"],
      "capability_order": ["search", "read", "query", "create"],
      "required_scopes": [], "scope_order": ["read_content", "insert_content"],
      "api_base_url": "https://api.notion.com", "api_version": "2026-03-11",
    ...
    '{"provider": "notion", "seeded_by": "db/migrations/0227_wave_b_integrations.sql"}'::jsonb
),
(
    'spotify', 'Spotify', 'media', 'oauth2', 'available',
    '{
    ...
    '{
      "flow": "oauth2_authorization_code_pkce", "secret_storage": "~/.hexis/auth",
      "supported_surfaces": ["chat", "cli", "web", "mcp"],
      "default_capabilities": ["search", "playback_state"],
      "capability_order": ["search", "playback_state", "playback_control"],
      "required_scopes": [], "scope_order": ["user-read-private", "user-read-playback-state", "user-modify-playback-state"],
    ...
    '{"provider": "spotify", "seeded_by": "db/migrations/0227_wave_b_integrations.sql"}'::jsonb
),
(
    'home_assistant', 'Home Assistant', 'home', 'api_key', 'available',
    '{
    ...
    '{
      "flow": "explicit_env_reference", "secret_storage": "environment",
      "supported_surfaces": ["chat", "cli", "web", "mcp"],
      "default_capabilities": ["states"], "capability_order": ["states", "service_control"],
      "required_scopes": [], "scope_order": [],
      "credential_fields": [
    ...
    '{"provider": "home_assistant", "seeded_by": "db/migrations/0227_wave_b_integrations.sql"}'::jsonb
),
(
    'weather', 'Weather', 'information', 'manual', 'available',
    '{"forecast": {"label": "Current conditions and forecast", "scope_kind": "read", "status": "available", "scopes": []}}'::jsonb,
    '{
      "flow": "location_verification", "secret_storage": "none",
      "supported_surfaces": ["chat", "cli", "web", "heartbeat", "mcp"],
      "default_capabilities": ["forecast"], "capability_order": ["forecast"],
      "required_scopes": [], "scope_order": [],
    ...
    '{"provider": "open_meteo", "seeded_by": "db/migrations/0227_wave_b_integrations.sql"}'::jsonb
),
(
    'trello', 'Trello', 'productivity', 'api_key', 'available',
    '{
    ...
    '{
      ...
      "required_scopes": [], "scope_order": ["read", "write"],
    ...
    '{"provider": "trello", "seeded_by": "db/migrations/0227_wave_b_integrations.sql"}'::jsonb
)
...
INSERT INTO connector_action_tool_map (
    tool_name, connector_id, action_kind, target_argument,
    account_argument, sensitivity, metadata
) VALUES
