-- Durable belief-update propagation, delivery receipts, and heartbeat surfacing.
SET search_path = public, ag_catalog, "$user";

CREATE TABLE IF NOT EXISTS belief_update_log (
...
CREATE TABLE IF NOT EXISTS belief_update_deliveries (
...
-- Surface only changes since the prior heartbeat in the next decision context.
